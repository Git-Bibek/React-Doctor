...
import {ImageOnlyCard} from "../components/card/card.component.tsx";
import {FaEnvelope, FaGithub, FaGlobe, FaLinkedin, FaMapMarkerAlt, FaPhone} from "react-icons/fa";
import {ContactField} from "../components/form/display.form.tsx";

const ProfilePage = () => {
    return (
        <>
            <div className={'bg-[#f4f7fd] min-h-screen py-10'}>
